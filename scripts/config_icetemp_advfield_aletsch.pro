; GloGEM config — Aletsch/Morteratsch paired advection experiment, WITH advection.
;
...
;
; Companion (advection OFF): scripts/config_icetemp_advfield_aletsch_noadv.pro
...
dirres     = '/scratch_net/vierzack04_fourth/jabeer/GloGEM/glogemflow_development/icetemp_advfield_aletsch_morteratsch/adv/'
RGIversion = '7'
