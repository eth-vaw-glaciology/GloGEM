...
function glacier, glacier_id, region, chain, params = params
  compile_opt idl2
  ...
  ; Parse parameters using the separate parsing function
  working_params = parse_glacier_params(params = params, _extra = extra)

  ; Directly extract all parameters from the working_params structure
  aflow = working_params.aflow
  calibration_method = working_params.calibration_method
  dx = working_params.dx
  display_during_flag = working_params.display_during_flag
  display_end_flag = working_params.display_end_flag
  dtfactor = working_params.dtfactor
  dt_flag = working_params.dt_flag
  flag_startobs = working_params.flag_startobs
  frontal_length = working_params.frontal_length
  mb_bias_flag = working_params.mb_bias_flag
  mb_sur_flag = working_params.mb_sur_flag
  mb_type_flag = working_params.mb_type_flag
  nyears = working_params.nyears
  smb_sinus_flag = working_params.smb_sinus_flag
  ss_criterion = working_params.ss_criterion
  start_year = working_params.start_year
  width_flag = working_params.width_flag
