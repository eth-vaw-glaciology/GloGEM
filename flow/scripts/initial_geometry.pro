...
if display_during_flag eq 1 then begin ; typically not displayed, but may be useful for debugging
  ...
  p1 = plot(x_input, th_input, /current, $
    title = 'Ice Thickness', $
