...
if time_resolution eq 'monthly' then begin
  ...
  ; GCM --- CLIMATE FILE
   ...
   READ_CLIMATEPAST_MONTHLY,dir_clim,dir_region,ccl,reanalysis,submonth_variability, rtemp,rprec,rvariab,rtg, rlon,rlat,relev,nlons,nlats,lon0,lat0,ntime, ryear,rmon, time_resolution
...
CALVING_MODEL,thick,bed_elev,bed_elev_term,bed_elev_p,dvol,frontal_ablation,front_melt,calv_amplification,width,slope,length,alpha_f,length_corrfact,crit_ccorrdist,ccorr_expon,ccorr_param,area,acc,dens,ye,tran,id,gg,g
