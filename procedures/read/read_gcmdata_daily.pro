...
fn=dir_clim+'/future/'+time_resolution+'/'+GCMdata+'/'+dir_region+'/'+GCM_model(gcms)+'/latitudes.dat'
...
fn=dir_clim+'/future/'+time_resolution+'/'+GCMdata+'/'+dir_region+'/'+GCM_model(gcms)+'/'+GCM_rcp(rcps)+'/'+'clim_'+gxg+'_'+gyg+'.dat'
