...
;
; Read the monthly reanalysis climate time series for the grid point
...
fn = dir_clim + 'reanalysis/monthly/' + reanalysis + '/' + dir_region + '/clim_' + gxs + '_' + gys + '.dat'
...
endelse
print, fn
anz=file_lines(fn)-3 & da=dblarr(5,anz) & tt=strarr(3)
