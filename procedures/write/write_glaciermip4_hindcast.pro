...
fn_ann   = outdir + 'GloGEM_rgi' + rgi_str + '_' + gcm_tag + '_ERA5_annual.nc'
fn_mon   = outdir + 'GloGEM_rgi' + rgi_str + '_' + gcm_tag + '_ERA5_monthly.nc'
fn_ann_i = outdir + 'GloGEM_rgi' + rgi_str + '_' + gcm_tag + '_indiv_ERA5_annual.nc'
fn_mon_i = outdir + 'GloGEM_rgi' + rgi_str + '_' + gcm_tag + '_indiv_ERA5_monthly.nc'
