...
tt=mean(btongue) & if tt lt -100 then tt=-100
if meltmodel eq '1' then printf,3,id[gg[g]],mean(mb),mean(wb),area1,mean(ela),mean(aar),$
    mean(dbdz)*100.,tt,DDFsnow,DDFice,c_prec,t_offset,flag,fo='(a,2f9.3,f11.3,i6,f6.1,2f9.3,2f7.3,f9.3,f7.2,i3)'
if meltmodel eq '3' then printf,3,id[gg[g]],mean(mb),mean(wb),area1,mean(ela),mean(aar), $
    mean(dbdz)*100.,tt,C0,C1,alb_ice,alb_snow,c_prec,t_offset,flag,fo='(a,2f9.3,f11.3,i6,f6.1,2f9.3,2f8.2,3f8.4,f7.2,i3)'
